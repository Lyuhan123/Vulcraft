...
import com.yuhan123.vulkanmod.vulkan.queue.*;
...
import static com.yuhan123.vulkanmod.vulkan.queue.Queue.findQueueFamilies;
...
public abstract class DeviceManager {
    ...
    public static void init(VkInstance instance) {
        try {
            ...
            VulkanMod.LOGGER.info(getAvailableDevicesInfo());
...
//                Initializer.CONFIG.device = -1;
    ...
    public static void createLogicalDevice() {
        try (MemoryStack stack = stackPush()) {
            ...
            com.yuhan123.vulkanmod.vulkan.queue.Queue.QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
...
//            createInfo.ppEnabledLayerNames(Vulkan.ENABLE_VALIDATION_LAYERS ? asPointerBuffer(Vulkan.VALIDATION_LAYERS) : null);
    ...
    private static VkExtensionProperties.Buffer getAvailableExtension(MemoryStack stack, VkPhysicalDevice device) {
        ...
        VkExtensionProperties.Buffer availableExtensions = VkExtensionProperties.malloc(extensionCount.get(0));//out of stack
