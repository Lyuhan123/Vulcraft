package com.yuhan123.vulkanmod.vulkan.shader.converter;
...
//        this.state = State.None;
    ...
    public UBO createUBO() {
        ...
        for (Uniform uniform : this.globalUniforms) {
            ...
            com.yuhan123.vulkanmod.vulkan.shader.layout.Uniform.Info uniformInfo = com.yuhan123.vulkanmod.vulkan.shader.layout.Uniform.createUniformInfo(type, name);
